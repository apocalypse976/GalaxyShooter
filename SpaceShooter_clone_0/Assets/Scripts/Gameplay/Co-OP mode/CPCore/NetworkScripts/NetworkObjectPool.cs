...
namespace Unity.BossRoom.Infrastructure
{
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        Dictionary<GameObject, int> Non_PooledObjects = new Dictionary<GameObject, int>();
        ...
        public void InitializePool()
        {
            ...
            {
                Non_PooledObjects[configObject.Prefab] = 0;
        ...
        public void ReturnNetworkObject(NetworkObject networkObject, GameObject prefab)
        {
            ...
            Non_PooledObjects[prefab]--;
        }
        public int GetCurrentPrefabs(GameObject prefab)
        {
            return Non_PooledObjects[prefab];
        }
